...
Bạn **đưa nguồn + đặt câu hỏi**, còn AI lo **toàn bộ việc bảo trì**: viết note, liên kết chéo, cập nhật mục lục, phát hiện mâu thuẫn. (Đây là *LLM Wiki pattern* — xem [01-GIAI-THICH-KIEN-THUC.md](01-GIAI-THICH-KIEN-THUC.md).)
...
3. **Dán SETUP-PROMPT:** mở [02-SETUP-PROMPT.md](02-SETUP-PROMPT.md), copy toàn bộ phần trong khung và dán vào Claude Code.
...
6. **Bắt đầu dùng:** đọc [04-HUONG-DAN-SU-DUNG.md](04-HUONG-DAN-SU-DUNG.md) (Claude cũng sẽ tạo bản riêng trong kho của bạn).
...
## Bộ file trong kit này (theo hành trình: hiểu → setup → dùng)
| File | Dùng để |
|---|---|
| `00-ONBOARD-HOC-VIEN.md` | Bạn đang đọc — tổng quan & các bước |
| `01-GIAI-THICH-KIEN-THUC.md` | **HIỂU** — *vì sao* hệ thống này hoạt động (LLM Wiki, 3 lớp, workflow) |
| `02-SETUP-PROMPT.md` | **SETUP** — prompt chính dán vào Claude Code để dựng kho |
| `03-CLAUDE-TEMPLATE.md` | Mẫu `CLAUDE.md` (luật vận hành) — tham chiếu cho setup |
| `04-HUONG-DAN-SU-DUNG.md` | **SỬ DỤNG** — hướng dẫn dùng hằng ngày |
